...
def analyze_message_for_memories_and_actions(client, user, message_text: str, active_page: str):
    ...
    prompt = (
        ...
        "- The title field must always be a short, clean event name (2-4 words, title case). "
        "Never a question, never a full sentence, never a verb phrase. "
        "Good: 'Dentist Appointment', 'Flight to Miami', 'Math Exam', 'Donald\\'s Birthday'. "
        "Bad: 'Add dentist appointment to calendar?', 'You have a dentist appointment', 'Schedule dentist'.\n"
