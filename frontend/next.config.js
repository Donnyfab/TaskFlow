...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      { source: '/remove_profile_image',  destination: `${backendOrigin}/remove_profile_image` },
      { source: '/static/uploads/:path*', destination: `${backendOrigin}/static/uploads/:path*` },
      ...
      { source: '/ping', destination: `${backendOrigin}/ping` },
    ]
  },
}
