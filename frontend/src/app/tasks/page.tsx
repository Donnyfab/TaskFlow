...
export default function TasksPage() {
  ...
  const fetchData = useCallback(async (lid: number|null) => {
  ...
  useEffect(() => { fetchData(listId) }, [listId, fetchData])
  ...
  const visible    = filter === 'all' ? tasks : filter === 'active' ? incomplete : completed
